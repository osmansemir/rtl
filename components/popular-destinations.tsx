...
export default function PopularDestinations() {
  return (
    <div>
      <section id="destinations" className="py-12 sm:py-20 px-6 bg-light">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-sm text-muted"> / 7 days</span>
                  </div>
                  <button className="w-10 h-10 rounded-full bg-light flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-sm text-muted"> / 5 days</span>
                  </div>
                  <button className="w-10 h-10 rounded-full bg-light flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                    <svg
                      className="w-5 h-5"
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-sm text-muted"> / 6 days</span>
                  </div>
                  <button className="w-10 h-10 rounded-full bg-light flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                    <svg
                      className="w-5 h-5"
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-sm text-muted"> / 8 days</span>
                  </div>
                  <button className="w-10 h-10 rounded-full bg-light flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                    <svg
                      className="w-5 h-5"
