      ...
      <section className="pt-16 sm:pt-24 pb-12 sm:pb-20 px-6 min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto pt-16">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--primary)]/10 rounded-full text-sm font-medium mb-6">
                <svg
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Discover Your
                <br />
                <span className="text-[var(--primary)]">Next Adventure</span>
              </h1>
              <p className="text-lg text-[var(--text-muted)] mb-8 max-w-md">
              ...
              <div className="flex gap-6 sm:gap-8">
                ...
                <div>
                  <div className="text-2xl font-bold flex items-center gap-1">
                    <span className="text-[var(--secondary)]">★</span>4.9
                  </div>
                  <div className="text-sm text-[var(--text-muted)]">Rating</div>
                </div>
              </div>
            </div>
